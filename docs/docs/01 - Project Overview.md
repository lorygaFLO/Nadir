...
Open modeling questions that go beyond this scope — notably how to handle KPIs that are in opposition to each other — are tracked separately in [[Future Developments]].
